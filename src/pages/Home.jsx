...
const Home = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-text", { y: 100, opacity: 0, duration: 1, stagger: 0.2, ease: "power4.out" })
        .from(".hero-img", { scale: 1.2, opacity: 0, duration: 1.5, ease: "expo.out" }, "-=0.8");
    ...
    <div ref={containerRef} className="bg-cafe-dark text-cafe-cream">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="hero-text mt-10">
            <Link to="/menu" className="group relative px-10 py-4 overflow-hidden border border-cafe-gold text-cafe-gold transition-all">
              <span className="relative z-10 flex items-center gap-2 font-medium group-hover:text-cafe-dark transition-colors">
                DISCOVER MENU <ArrowRight size={20} className="group-hover:translate-x-2 transition-transform" />
              </span>
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        ...
        <div className="reveal space-y-8">
          <h2 className="text-5xl font-serif font-bold text-cafe-gold">A Slice of the <br/> mountains in Kalighat.</h2>
          <p className="text-xl text-gray-400 leading-relaxed">
            From juicy, handmade <span className="text-cafe-cream">Momos</span> to the comforting warmth of <span className="text-cafe-cream">Thukpa</span> and <span className="text-cafe-cream">Shapta</span>, we bring the authentic taste of the Himalayas to the heart of Kolkata.
          </p>
