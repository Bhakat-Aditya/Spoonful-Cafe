    ...
    <div className="bg-cafe-dark text-cafe-cream min-h-screen">
      ...
      >
        ...
        <div className="md:col-span-1 space-y-8">
          ...
          <div className="loc-card p-8 bg-cafe-gold text-cafe-dark rounded-3xl flex flex-col items-center text-center gap-4 group cursor-pointer">
        ...
        <div className="md:col-span-2 loc-card h-[600px] relative rounded-3xl overflow-hidden border border-cafe-gold/20">
          {/* Iframe Mockup / Actual Google Map */}
          <iframe
            title="Spoonful Cafe Location"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3673.5!2d88.34!3d22.52!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDMyJzEyLjAiTCA4OMKwMjBnMzQuMCIgTTherefore!"
            className="w-full h-full grayscale invert opacity-80"
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
          ></iframe>
          <div className="absolute top-6 left-6 bg-cafe-dark/80 backdrop-blur-md p-4 rounded-xl border border-cafe-gold/30">
            <p className="text-xs uppercase tracking-widest text-cafe-gold">
              Current Location
            </p>
            <p className="text-white font-serif">Lake Market, Kolkata</p>
          </div>
        </div>
      </section>
    </div>
